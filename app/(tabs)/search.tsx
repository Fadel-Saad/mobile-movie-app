...
export default function Search() {
  ...
  useEffect(() => {
    // using timeout fn to debounce API calls
          ...
          <>
            ...
            <View className="my-5">
              <SearchBar
                ...
                value={searchQuery}
                // unlike react, we don't need to get the event and set the state to e.target.value
                onChangeText={setSearchQuery}
                // 2nd way: onChangeText={(text: string) => setSearchQuery(text)}
              />
            </View>
